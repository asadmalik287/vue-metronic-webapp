                      ...
                      <div>
                        <ul class="list-unstyled mb-0">
                          ...
                          <li class="p-2">
                            ...
                            <div class='mt-3'>
                              <input class='form-control bagDark formInput w-100 border-0 fs-12 text-white' type="text"
                                name="text" value="">
                            </div>
                          </li>
                          <li class="p-2">
                            <p class="fs-12 mb-0 text-grey pb-2">Background Position</p>
                            <select v-model="backgroundPosition" @change="updateStyling" class="form-select bagDark border-0 text-white formInput w-100 fs-12"
                          ...
                          <li class="p-2 ">
                            ...
                            <select class="form-select bagDark border-0 text-white formInput w-100 fs-12"
                              ...
                              <option onselect="myFunction()" value="2" class="fs-12">Radial gradient</option>
